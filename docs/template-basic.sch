...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      <sch:assert test="count(f:extension[@url = 'http://www.fhir.org/guides/sampler2/StructureDefinition/extension-blah']) &lt;= 1">extension with URL = 'http://www.fhir.org/guides/sampler2/StructureDefinition/extension-blah': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://www.fhir.org/guides/sampler2/StructureDefinition/extension-complex']) &lt;= 1">extension with URL = 'http://www.fhir.org/guides/sampler2/StructureDefinition/extension-complex': maximum cardinality of 'extension' is 1</sch:assert>
