...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Basic">
      <sch:assert test="count(f:extension[@url = 'http://www.fhir.org/guides/ig-sampler/StructureDefinition/extension-blah']) &lt;= 1">extension with URL = 'http://www.fhir.org/guides/ig-sampler/StructureDefinition/extension-blah': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://www.fhir.org/guides/ig-sampler/StructureDefinition/extension-complex']) &lt;= 1">extension with URL = 'http://www.fhir.org/guides/ig-sampler/StructureDefinition/extension-complex': maximum cardinality of 'extension' is 1</sch:assert>
